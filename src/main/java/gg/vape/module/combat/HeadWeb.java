...
extends UtilityMod {
    ...
    public void onEnable() {
        ...
        if (this.cobwebSlot < 0) {
            Vape.INSTANCE.getNotificationManager().show("HeadWeb", "Cobweb not in hotbar", NotificationType.WARNING,
                    3000L);
            this.setEnabled(false, true);
            return;
        }
    ...
    private boolean aimPlacement() {
        ...
        this.webRotationController.setSpeed(PLACEMENT_AIM_SPEED);
